...
<nav class="w3-sidebar w3-bar-block w3-white w3-animate-left w3-text-grey w3-collapse w3-top w3-center" style="z-index:3;width:300px;font-weight:bold" id="mySidebar"><br>
  ...
  <a href="home_soal_siswa.php" onclick="w3_close()" class="w3-bar-item w3-button">SOAL SISWA</a>
   <a href="home_jawaban_siswa.php" onclick="w3_close()" class="w3-bar-item w3-button">JAWABAN SISWA</a>
...
<?php include 'tampilan_jawaban_pg.php';?>
</div>
<!-- login -->
